package com.zanelove.BaseAdapterHelper.Utils;
...
/**
 * Created by ZaneLove on 2014/3/15.
 */
public class ImageSizeUtil {
    ...
    public static ImageSize getImageViewSize(ImageView imageView){
        ...
        /**
         * 可以看到这里或者最大宽度，我们用的反射，而不是getMaxWidth()；维萨呢，因为getMaxWidth竟然要API 16，我也是醉了；为了兼容性，我们采用反射的方案。
         */
        if(width <= 0 ) {
